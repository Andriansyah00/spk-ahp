...
<body class="hold-transition sidebar-mini layout-fixed" id="appbd">
  <div class="wrapper">
    ...
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-dark bg-gradient-red">
      <!-- Left navbar links -->
      <ul class="navbar-nav">
        <li class="nav-item">
    ...
    <aside class="main-sidebar sidebar-light-blue elevation-4" style="overflow-x: hidden">
      ...
      <a href="<?= base_url() ?>" class="brand-link">
        ...
        <span class="brand-text">
          <marquee><?= strtoupper($set->app_title) ?></marquee>
        </span>
      </a>
      <!-- Sidebar -->
      <div class="sidebar sidebar-light-red">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <?php foreach ($bcb as $r) {
                  if ($r['url'] != '') { ?>
                    <li class="breadcrumb-item"><a href="<?= $r['url'] ?>" style="color: #ff0000;"><?= $r['jdl'] ?></a></li>
                  <?php } else { ?>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2024  <a href="https://github.com/Andriansyah00">Sistem Pendukung Keputusan</a>.</strong>
      All rights reserved.
